...
public interface Builder<R, T extends R, P, S extends Builder<R, T, P, S>> extends NonNullSupplier<RegistryEntry<R, T>> {
    ...
    /**
     * Register the entry and return the parent object. The {@link io.github.fabricators_of_create.porting_lib.registry.DeferredHolder} will be created but not returned. It can be retrieved later with {@link AbstractRegistrate#get(ResourceKey)} or
